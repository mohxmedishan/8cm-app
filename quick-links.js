...
export const QUICK_LINK_LOGOS = {
  whatsapp: {
    label: "WhatsApp",
    tint: "#25d366",
    image: "https://cdn.jsdelivr.net/gh/mohxmedishan/8cm-assets@main/WA-logo.png",  // 1:1
  ...
  classroom: {
    ...
    tint: "#0F9D58",
    image: "https://cdn.jsdelivr.net/gh/mohxmedishan/8cm-assets@main/GC-logo.png",
  ...
  campus: {
    ...
    tint: "#d6492c",
    image: "https://cdn.jsdelivr.net/gh/mohxmedishan/8cm-assets@main/DC-logo.png",
